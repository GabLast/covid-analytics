...
import com.myorg.covid_analytics.repositories.process.CovidLoadDetailsRepository;
...
@Transactional
@Slf4j
public class CovidLoadDetailsService extends BaseService<CovidLoadDetails, Long> {

    private final CovidLoadDetailsRepository repository;

    @Override
    protected JpaRepository<CovidLoadDetails, Long> getRepository() {
        return repository;
    }

    @Transactional(readOnly = true)
    public List<CovidLoadDetails> findAllFilter(
            boolean enabled, String timeZoneId,
            Long headerId, String countryCode,
