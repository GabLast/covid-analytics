...
public class ProfileControllerTest extends AbstractControllerTest {
    ...
    void fetch() throws Exception {
        ...
        mockMvc.perform(
                        get("/api/v1/profile/fetch").header("Authorization", "Bearer " + token))
                .andExpect(status().is(
    ...
    void postTest() throws Exception {
        ...
        mockMvc.perform(
                post("/api/v1/profile").contentType(APPLICATION_JSON_VALUE).content(json2)
    ...
    void getTest() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/profile" + "?id=" + 1).header("Authorization",
    ...
    void findall() throws Exception {
        ...
        mockMvc.perform(
                        get("/api/v1/profile/findall").header("Authorization", "Bearer " + token))
                .andExpect(status().is(
                        oneOf(HttpStatus.OK.value(), HttpStatus.UNAUTHORIZED.value())));
    }
    ...
    void countall() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/profile/countall").header("Authorization",
                "Bearer " + token)).andExpect(status().is(
                oneOf(HttpStatus.OK.value(), HttpStatus.UNAUTHORIZED.value())));
    }
    ...
    void deleteTest() throws Exception {
        ...
        mockMvc.perform(delete("/api/v1/profile" + "?id=" + 1).header("Authorization",
                "Bearer " + token)).andExpect(status().is(
                oneOf(HttpStatus.OK.value(), HttpStatus.NOT_FOUND.value(),
